...
void* winrt_make_Wintun2socks_TcpSocket();
void* winrt_make_Wintun2socks_Wintun();
...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"Wintun2socks.TcpSocket"))
    {
        return winrt_make_Wintun2socks_TcpSocket();
    }

    if (requal(name, L"Wintun2socks.Wintun"))
    {
        return winrt_make_Wintun2socks_Wintun();
    }
